...
- [ ] Relancer ce jeu de test à chaque modification de `regles_redaction.md` ou des prompts des nodes — objectif : détecter une régression avant qu'elle parte en candidature réelle (pas encore automatisé/rappelé systématiquement, reste un geste manuel)
